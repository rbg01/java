...
public class Blackjack {
	...
	private static int apuesta;	//cu�nto quiere apostar el jugador
	private static int contadorAce;	//cu�ntos Ace tiene el jugador en la mano
	...
	public static void main(String[] args){
	    ...
	    */
		...
		/*
	    System.out.println("�Con cu�nto dinero quieres empezar?");
	    dinero = new Scanner(System.in);
	    efectivo = dinero.nextInt();
	    */
		String dinero = JOptionPane.showInputDialog("¿Con cuánto dinero quieres empezar?");
	    ...
	    */
	    ...
	    while(efectivo>0){
	        ...
	        */
	        ...
	        System.out.println("El dealer est� ense�ando: ");
	        ...
	        else
	        {
	            ...
	            {
	                System.out.println("�Te gustar�a doblar?");	//permite al jugador doblar.
	            ...
	            if(pedido.equals("paso"))	//el jugador pasa
	            {
	                ...
	                {
	                    int jugador = 21-valorMano;	//comprueba qui�n est� m�s cerca de 21
	...
	public static int Apuesta(int efectivo)
	{
	    ...
	    while(apuesta>efectivo)
	    {
	        ...
	        System.out.println("�Cu�nto quieres apostar?");
	...
	/*
	 * A�ade una carta a la mano del usuario y calcula el valor de la mano. Los Aces se toman en cuenta.
	 */
